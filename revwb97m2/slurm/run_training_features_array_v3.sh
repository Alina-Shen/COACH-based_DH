...
#SBATCH --array=0-15%8
#SBATCH --output=/clusterfs/mhg-data/yaoshen/coach-based_dh_data/revwb97m2/logs/training_v3_%A_%a.out
...
plan=${2:-revwb97m2/manifests/production_generator/training_first16_v3.json}
module purge
...
/global/home/users/yaoshen/.conda/envs/dh/bin/python -u -m revwb97m2.scripts.generate_training_features_v2 run \
