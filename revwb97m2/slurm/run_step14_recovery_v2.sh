#!/usr/bin/env bash
#SBATCH --job-name=r2_s14_recovery2
...
/global/home/users/yaoshen/.conda/envs/coach/bin/python -m revwb97m2.scripts.run_step14_recovery_v2 --index "$SLURM_ARRAY_TASK_ID"
