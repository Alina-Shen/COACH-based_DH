"""Version 2 corrected-evidence fixed-orbital generation/reuse; frozen, gated, non-submitting CLI.
...
from revwb97m2.scripts import corrected_canary_evidence as corrected
