...
#SBATCH --output=/clusterfs/mhg-data/yaoshen/coach-based_dh/coach_mp2/results/step5_native_audit_%j.log
set -euo pipefail
...
/global/home/users/yaoshen/.conda/envs/dh/bin/python -B coach_mp2/scripts/check_step5_native_v2.py
