"""Independent semilocal feature reference for fixed COACH orbitals.

Adapted from revwb97m2 at omega=0.27. Generates three 96-feature rows;
the target adds four scalar columns. Contains no published COACH coefficients.
"""
